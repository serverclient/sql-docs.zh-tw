---
title: SqlPackage 指令碼
description: 了解如何使用 SqlPackage.exe Script 將資料庫開發工作自動化。 檢視範例及可用的參數、屬性和 SQLCMD 變數。
ms.prod: sql
...
ms.locfileid: "97577804"
---
# <a name="sqlpackage-script-parameters-and-properties"></a>SqlPackage Script 參數與屬性
SqlPackage.exe Script 動作建立的 Transact-SQL 累加式更新指令碼會更新目標資料庫的結構描述，使其符合來源資料庫的結構描述。 
...
## <a name="parameters-for-the-script-action"></a>Script 動作的參數
