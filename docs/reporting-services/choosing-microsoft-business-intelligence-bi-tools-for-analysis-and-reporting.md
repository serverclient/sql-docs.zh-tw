...
|執行自助式預測分析||||||[適用於 Excel 的資料採礦增益集](/previous-versions/sql/2014/analysis-services/data-mining-client-for-excel-sql-server-data-mining-add-ins?view=sql-server-2014&preserve-view=true) |  
