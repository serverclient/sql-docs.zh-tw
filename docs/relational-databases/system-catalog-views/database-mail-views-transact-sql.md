---
description: Database Mail 檢視 (Transact-SQL)
...
ms.locfileid: "98092605"
---
# <a name="database-mail-views-transact-sql"></a>Database Mail 檢視 (Transact-SQL)
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]

  Database Mail 具有下列檢視，可顯示 Database Mail 電子郵件內容、電子郵件狀態和任何收到的訊息，如 Database Mail 記錄的錯誤。 這些視圖位於 **msdb** 資料庫中。  
